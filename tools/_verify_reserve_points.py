#!/usr/bin/env python3
"""Verify reserve PMC extract pixels on DEV A satellite PNG."""
...
META = json.loads((ROOT / "internal/maps_tarkov.dev/reserve/meta.json").read_text(encoding="utf-8"))
PMC = json.loads((ROOT / "internal/points/exfil/pmc.json").read_text(encoding="utf-8"))["reserve"]
...
def main() -> None:
    png_path = ROOT / "internal/maps_tarkov.dev/reserve/map.png"
    ...
    out = ROOT / "tools/_reserve_verify.png"
    img.save(out)
