...
const MAP_PLAYER_PROFILES = {
  factory: {
    ...
    eftarkov: { swapGameAxes: true, flipX: true, flipY: true, headingOffset: 90 },
  },
  customs: {
    dev_a: {},
    dev_b: {},
    eftarkov: { flipY: true, headingOffset: 180 },
  },
  groundzero: {
    dev_a: {},
    dev_b: {},
  ...
  labs: {
    dev_a: { flipHeadingY: true, flipHeadingX: true, headingOffset: 90 },
    dev_b: { flipHeadingY: true, flipHeadingX: true, headingOffset: 90 },
    eftarkov: { swapGameAxes: true, headingOffset: 270 },
  },
};
